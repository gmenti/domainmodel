...
public class InternalDomainModelParser extends AbstractInternalContentAssistParser {
    ...
    // InternalDomainModel.g:62:1: ruleModel : ( ( rule__Model__ElementsAssignment )* ) ;
    public final void ruleModel() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalDomainModel.g:66:2: ( ( ( rule__Model__ElementsAssignment )* ) )
            // InternalDomainModel.g:67:2: ( ( rule__Model__ElementsAssignment )* )
            {
            // InternalDomainModel.g:67:2: ( ( rule__Model__ElementsAssignment )* )
            // InternalDomainModel.g:68:3: ( rule__Model__ElementsAssignment )*
            {
             before(grammarAccess.getModelAccess().getElementsAssignment()); 
            // InternalDomainModel.g:69:3: ( rule__Model__ElementsAssignment )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalDomainModel.g:69:4: rule__Model__ElementsAssignment
            	    {
            	    pushFollow(FOLLOW_3);
    ...
    // InternalDomainModel.g:1079:1: rule__Model__ElementsAssignment : ( ruleAbstractElement ) ;
